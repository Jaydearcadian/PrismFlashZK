    ...
    <div className="flex flex-col divide-y divide-[#E5E5E5] dark:divide-[#1e1b22] bg-white dark:bg-[#17151b]">
      <div className="p-4 bg-[#FAFAFA] dark:bg-[#141217] flex items-center justify-between border-b border-[#E5E5E5] dark:border-[#1e1b22]">
        <div>
          ...
          <p className="text-[9px] text-[#666666] dark:text-[#a09ba8] font-mono uppercase tracking-tight">Configure TEE hardware enclaves, live testnet RPC addresses, and customize simulation models</p>
        </div>
      </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center bg-[#FAFAFA] dark:bg-[#141217] p-4 border dark:border-[#1e1b22]">
            <div className="flex-1 space-y-1">
              <span className="text-[11px] font-bold text-black dark:text-white block">TEE HARDWARE ENFORCEMENT</span>
              <p className="text-[10px] text-[#6b6472] leading-relaxed font-mono">
            ...
            <div className="flex items-center gap-3 bg-white dark:bg-[#17151b] border border-[#E5E5E5] dark:border-[#1e1b22] p-2">
              <span className="text-[9px] font-mono text-[#666666] dark:text-[#a09ba8] uppercase">STATUS:</span>
              <button 
                onClick={() => {
                ...
                className={`relative inline-flex h-5 w-9 shrink-0 cursor-pointer border border-[#E5E5E5] dark:border-[#2d2833] rounded-none transition-colors duration-200 ease-in-out focus:outline-none ${isHardwareEnforced ? 'bg-[#d9a078] dark:bg-[#c88f68]' : 'bg-[#E5E5E5] dark:bg-[#1e1b22]'}`}
              >
              ...
              <span className={`text-[9px] font-mono uppercase px-1 py-0.5 border ${isHardwareEnforced ? 'bg-[#d9a078]/10 text-[#d9a078] dark:text-[#d9a078] border-[#d9a078]/30' : 'bg-[#FAFAFA] dark:bg-[#1e1b22] text-[#999999] border-[#E5E5E5] dark:border-[#1e1b22]'}`}>
                {isHardwareEnforced ? "TEE KEY VALIDATED" : "OPTIMISTIC"}
              </span>
            </div>
          </div>
          {isHardwareEnforced && (
            <div className="p-3 bg-[#d9a078]/5 border border-[#d9a078]/20 text-[#8a6a4f] dark:text-[#d9a078] font-mono text-[9px] space-y-1">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-3 p-4 bg-[#f4f2f7] dark:bg-[#141217]/40 border dark:border-[#1e1b22]">
            {/* EVM */}
            <div className="space-y-1 font-mono text-[10px]">
              <span className="font-bold text-[#6b6472] uppercase">Base Sepolia Escrow Contract Address:</span>
              <input
                type="text"
                value={liveContracts.baseEscrow}
                onChange={(e) => setLiveContracts({ ...liveContracts, baseEscrow: e.target.value })}
                className="w-full bg-white dark:bg-[#17151b] border border-[#E5E5E5] dark:border-[#1e1b22] px-3 py-1.5 text-[10.5px] text-black dark:text-white font-mono focus:outline-none focus:border-[#d9a078] dark:focus:border-[#d9a078] transition-colors"
              />
            </div>
            {/* Stellar */}
            <div className="space-y-1 font-mono text-[10px]">
              <span className="font-bold text-[#6b6472] uppercase">Stellar Soroban Clearinghouse Address:</span>
              <input
                type="text"
            ...
            {/* Solana */}
            <div className="space-y-1 font-mono text-[10px]">
              <span className="font-bold text-[#6b6472] uppercase">Solana Devnet Vault Program ID:</span>
              <input
                type="text"
            ...
            {/* Movement */}
            <div className="space-y-1 font-mono text-[10px]">
              <span className="font-bold text-[#6b6472] uppercase">Movement Porto Module Path:</span>
              <input
                type="text"
        ...
        <div className="space-y-3">
          ...
          <div className="p-4 bg-[#FAFAFA] dark:bg-[#141217] border dark:border-[#1e1b22] space-y-3 font-mono text-[10px] text-[#6b6472]">
            <p>
            ...
            <button
              ...
              className="py-2 px-4 bg-black dark:bg-[#c88f68] hover:bg-[#17151b] dark:hover:bg-[#d9a078] text-white dark:text-black font-sans text-[10px] font-bold uppercase cursor-pointer"
            >
